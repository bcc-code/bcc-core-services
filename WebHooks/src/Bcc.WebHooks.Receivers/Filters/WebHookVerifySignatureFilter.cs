...
using Bcc.WebHooks.Receivers.Utilities;
...
namespace Bcc.WebHooks.Receivers.Filters
{
    /// <summary>
    /// Base class for <see cref="IWebHookReceiver"/> and <see cref="IResourceFilter"/> or
    /// <see cref="IAsyncResourceFilter"/> implementations that verify request body content e.g. filters
    /// that verify signatures of request body content. Subclasses by default have an
    /// <see cref="IOrderedFilter.Order"/> equal to <see cref="WebHookSecurityFilter.Order"/>.
    /// </summary>
