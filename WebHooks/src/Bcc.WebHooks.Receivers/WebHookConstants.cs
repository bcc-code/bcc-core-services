...
using Bcc.WebHooks.Receivers.Routing;
using Microsoft.AspNetCore.Mvc.ModelBinding;
using Microsoft.AspNetCore.Routing;
using Microsoft.Extensions.Configuration;

namespace Bcc.WebHooks.Receivers
{
    /// <summary>
    ...
    public static class WebHookConstants
    {
        ...
        /// consistent <see cref="ModelStateDictionary"/> entries, separate from entries for (for
        ...
        /// <summary>
        /// Gets the name of the <see cref="RouteValueDictionary"/> entry containing the event name
        ...
        /// <summary>
        /// Gets the name of the <see cref="RouteValueDictionary"/> entry containing the receiver id
        /// for the current request.
        /// </summary>
        public static string IdKeyName => "id";

        /// <summary>
        /// Gets the name of the <see cref="RouteValueDictionary"/> entry containing the receiver
        ...
        /// <summary>
        /// Gets the name of the <see cref="RouteValueDictionary"/> entry containing an indication
