...
using System;
using Bcc.WebHooks.Receivers.Properties;
...
namespace Bcc.WebHooks.Receivers.Metadata
{
    ...
    public class WebHookParameter
    {
        ...
        /// The name of the HTTP header, <see cref="RouteValueDictionary"/> entry or query parameter
        ...
        /// <see cref="RouteValueDictionary"/> entry or query parameter is required in a WebHook
        /// request.
        /// </param>
        ...
        /// <summary>
        /// Gets the name of the HTTP header, <see cref="RouteValueDictionary"/> entry or query
        ...
        /// <see cref="RouteValueDictionary"/> entry or query parameter is missing, the receiver
