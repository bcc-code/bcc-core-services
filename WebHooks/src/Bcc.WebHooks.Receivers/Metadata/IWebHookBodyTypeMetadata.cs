...
namespace Bcc.WebHooks.Receivers.Metadata
{
    ...
    /// <see cref="ApplicationModels.WebHookBindingInfoProvider"/> sets <see cref="BindingInfo"/>
    ...
    public interface IWebHookBodyTypeMetadata : IWebHookMetadata
    {
        ...
        /// and, if such a parameter exists, it requires no additional <see cref="BindingInfo"/>.
        /// </value>
