...
namespace Bcc.WebHooks.Receivers.Metadata
{
    /// <summary>
    ...
    public class WebHookFilterMetadataContext
    {
        ...
        /// </summary>
        /// <param name="actionModel">The <see cref="Microsoft.AspNetCore.Mvc.ApplicationModels.ActionModel"/> of the action.</param>
        ...
        /// </summary>
        /// <param name="actionDescriptor">The <see cref="Microsoft.AspNetCore.Mvc.Abstractions.ActionDescriptor"/> of the action.</param>
        ...
        /// <summary>
        /// Gets the <see cref="Microsoft.AspNetCore.Mvc.ApplicationModels.ActionModel"/> of the action if calling
        ...
        /// <see cref="Microsoft.AspNetCore.Mvc.ApplicationModels.ActionModel"/> properties.
        /// </remarks>
        /// <value>
        /// The <see cref="Microsoft.AspNetCore.Mvc.ApplicationModels.ActionModel"/> of the action if calling
        /// <see cref="IWebHookFilterMetadata.AddFilters"/> from an <see cref="IApplicationModelProvider"/>
        ...
        /// <summary>
        /// Gets the <see cref="Microsoft.AspNetCore.Mvc.Abstractions.ActionDescriptor"/> of the action if calling
        /// <see cref="IWebHookFilterMetadata.AddFilters"/> within a WebHook request.
        /// </summary>
        /// <remarks>
        /// <see cref="IWebHookFilterMetadata"/> implementations should not write
        /// <see cref="Microsoft.AspNetCore.Mvc.Abstractions.ActionDescriptor"/> properties.
        /// </remarks>
        /// <value>
        /// The <see cref="Microsoft.AspNetCore.Mvc.Abstractions.ActionDescriptor"/> of the action if calling
